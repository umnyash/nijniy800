...
!function webpackUniversalModuleDefinition(root, factory) {
    ...
    , function(module, exports, __webpack_require__) {
        ...
        function isInputEventSupported(eventName) {
            ...
            return isSupported || (el.setAttribute(evName, "return;"),
        ...
        module.exports = function maskScope(actionObj, maskset, opts) {
            ...
            function getMaskTemplate(baseOnInput, minimalPos, includeMode, noJit, clearOptionalTail) {
                ...
                do {
                    if (!0 === baseOnInput && getMaskSet().validPositions[pos])
                        testPos = clearOptionalTail && !0 === getMaskSet().validPositions[pos].match.optionality && void 0 === getMaskSet().validPositions[pos + 1] && (!0 === getMaskSet().validPositions[pos].generatedInput || getMaskSet().validPositions[pos].input == opts.skipOptionalPartCharacter && 0 < pos) ? determineTestTemplate(pos, getTests(pos, ndxIntlzr, pos - 1)) : getMaskSet().validPositions[pos],
                        test = testPos.match,
                ...
                !1 === includeMode && void 0 !== getMaskSet().maskLength || (getMaskSet().maskLength = pos - 1),
                opts.greedy = greedy,
                maskTemplate
            }
            function getMaskSet() {
                            ...
                            if (match.isGroup && quantifierRecurse !== match) {
                                ...
                                if (-1 === altIndex || "string" == typeof altIndex) {
                                    ...
                                    if (getMaskSet().excludes[pos]) {
                                        ...
                                        0 === altIndexArr.length && (getMaskSet().excludes[pos] = void 0,
            ...
            function refreshFromBuffer(start, end, buffer) {
                ...
                i = start; i < end; i++)
                    ...
                    buffer[i] !== opts.skipOptionalPartCharacter) {
                        ...
                        !1 !== valResult && (resetMaskSet(!0),
                        p = void 0 !== valResult.caret ? valResult.caret : valResult.pos + 1)
                    }
            }
            ...
            function alternate(pos, c, strict, fromIsValid, rAltPos) {
                ...
                function insertPosition(insert) {
                    if (insert && isValidRslt && void 0 !== c) {
                        ...
                        pos += posOffset,
                        isValidRslt = isValid(targetLvp < pos ? targetLvp : pos, c, strict, fromIsValid, !0)
                    }
                }
                ...
                if (void 0 !== alternation) {
                    ...
                    for (; getMaskSet().excludes[decisionPos] && getMaskSet().excludes[decisionPos].length < 10; ) {
                        ...
                        for (getMaskSet().tests[decisionPos] = void 0,
                        resetMaskSet(!0),
                        isValidRslt = !0,
                        insertPosition(0 === pos); 0 < validInputs.length; ) {
                            var input = validInputs.shift();
                            if (!(isValidRslt = isValid(isValidRslt.caret || getLastValidPosition(void 0, !0) + 1, input, !1, fromIsValid, !0)))
                                break
                        }
                        if (insertPosition(0 < pos),
                        isValidRslt)
                            break;
                        if (resetMaskSet(),
                        ...
                        for (getMaskSet().excludes[decisionPos].push(decisionTaker),
                        i = decisionPos; i < getLastValidPosition(void 0, !0) + 1; i++)
                            delete getMaskSet().validPositions[i]
                    }
                }
                return getMaskSet().excludes[decisionPos] = void 0,
                isValidRslt
            }
            function isValid(pos, c, strict, fromIsValid, fromAlternate, validateOnly) {
                ...
                function processCommandObject(commandObj) {
                    if (void 0 !== commandObj) {
                        ...
                        commandObj = !0,
                        commandObj.rewritePosition = void 0)
                    }
                    return commandObj
                }
                function _isValid(position, c, strict) {
                    ...
                    return $.each(getTests(position), function(ndx, tst) {
                        var test = tst.match;
                        if (getBuffer(!0),
                        rslt = null != test.fn ? test.fn.test(c, getMaskSet(), position, strict, opts, isSelection(pos)) : (c === test.def || c === opts.skipOptionalPartCharacter) && "" !== test.def && {
                    ...
                    if (void 0 === getMaskSet().validPositions[ps] && !isMask(ps, !0)) {
                        ...
                        if (vp) {
                            ...
                            !0 !== fillOnly)) {
                                ...
                                return getMaskSet().validPositions[newPos] = void 0,
            ...
            function revalidateMask(pos, validTest, fromIsValid, validatedPos) {
                function IsEnclosedStatic(pos, valids, selection) {
                    ...
                    if (void 0 === posMatch || (!0 !== posMatch.match.static || !0 === posMatch.match.optionality) && posMatch.input !== opts.radixPoint)
                        return !1;
                    ...
                    begin < end && i++); i <= lvp; i++) {
                        ...
                        if (void 0 !== t && (end <= i || begin <= i && !0 !== t.generatedInput && IsEnclosedStatic(i, positionsClone, {
                            ...
                            for (; "" !== getTest(posMatch).match.def; ) {
                                ...
                                if (valid)
                                    break;
                                if (!valid && end < posMatch && isMask(posMatch, !0) && (!0 !== t.match.static || posMatch > getMaskSet().maskLength))
                                    break;
                                posMatch++
                            }
            ...
            function writeBuffer(input, buffer, caretPos, event, triggerEvents) {
                ...
                void 0 === caretPos || void 0 !== event && "blur" === event.type ? renderColorMask(input, caretPos, 0 === buffer.length) : caret(input, caretPos),
                !0 === triggerEvents)) {
                    var $input = $(input)
                ...
                if (-1 < pos && void 0 === getMaskSet().validPositions[pos]) {
                    ...
                    if (tests.length > 1 + ("" === tests[tests.length - 1].match.def ? 1 : 0))
                        for (var i = 0; i < tests.length; i++)
                            if (!0 !== tests[i].match.optionality && !0 !== tests[i].match.optionalQuantifier && (!0 === tests[i].match.static || void 0 === prevTest || !1 !== tests[i].match.fn.test(prevTest.match.def, getMaskSet(), pos, !0, opts)) && (staticAlternations.push(tests[i]),
            ...
            var EventRuler = {
                ...
                keydownEvent: function keydownEvent(e) {
                    ...
                    if (k === Inputmask.keyCode.BACKSPACE || k === Inputmask.keyCode.DELETE || iphone && k === Inputmask.keyCode.BACKSPACE_SAFARI || e.ctrlKey && k === Inputmask.keyCode.X && !isInputEventSupported("cut"))
                        ...
                        writeBuffer(this, getBuffer(!0), getMaskSet().p, e, this.inputmask._valueGet() !== getBuffer().join(""));
                        ...
                        pos.begin < getMaskSet().maskLength && (e.preventDefault(),
                        caret(this, pos.begin, pos.end))) : (opts.insertMode = !opts.insertMode,
                ...
                inputFallBackEvent: function inputFallBackEvent(e) {
                    ...
                    if (getBuffer().join("") !== inputValue) {
                        ...
                        if (inputValue = radixPointHandler(input, inputValue, caretPos),
                        ...
                        getBuffer().join("") !== inputValue) {
                            ...
                            if (frontPart !== frontBufferPart) {
                                ...
                                for (i = 0; frontPart.charAt(i) === frontBufferPart.charAt(i) && i < fpl; i++)
                                    ;
                                isEntry && (selection.begin = i - offset,
                ...
                beforeInputEvent: function beforeInputEvent(e) {
                    if (e.cancelable) {
                        ...
                        case "deleteContentBackward":
                            return keydown = new $.Event("keydown"),
                ...
                mouseenterEvent: function mouseenterEvent() {
                    var input = this;
                    mouseEnter = !0,
                    document.activeElement !== this && (this.placeholder !== originalPlaceholder && (originalPlaceholder = this.placeholder),
                ...
                if ($.each(inputValue, function(ndx, charCode) {
                    if (void 0 !== charCode)
                        if (void 0 === getMaskSet().validPositions[ndx] && inputValue[ndx] === getPlaceholder(ndx) && isMask(ndx, !0) && !1 === isValid(ndx, inputValue[ndx], !0, void 0, void 0, !0))
                            ...
                            charCodes = "")),
                            result ? (result.pos && getMaskSet().validPositions[result.pos] && !0 === getMaskSet().validPositions[result.pos].match.static && (staticMatches.push(result.pos),
                ...
                0 < staticMatches.length)
                    if (isComplete(getBuffer()))
                        ...
                        for (; sndx = staticMatches.pop(); ) {
                            var keypress = new $.Event("_checkval")
                              , nextSndx = sndx + 1;
                            for (validPos = getMaskSet().validPositions[sndx],
                            validPos.generatedInput = !0,
                            keypress.which = validPos.input.charCodeAt(0); (nextValid = getMaskSet().validPositions[nextSndx]) && nextValid.input === validPos.input; )
                                nextSndx++;
            ...
            function handleRemove(input, k, pos, strict, fromIsValid) {
                ...
                !0 !== fromIsValid))
                    for (; getMaskSet().p < lvp && void 0 === getMaskSet().validPositions[getMaskSet().p]; )
                        getMaskSet().p++
            }
            function initializeColorMask(input) {
                ...
                function findCaretPos(clientx) {
                    ...
                    itl = inputText.length; caretPos <= itl; caretPos++) {
                        if (e.innerHTML += inputText.charAt(caretPos) || "_",
                ...
                $(colorMask).on("click", function(e) {
                    return caret(input, findCaretPos(e.clientX)),
            ...
            function renderColorMask(input, caretPos, clear) {
                ...
                function setEntry(entry) {
                    if (void 0 === entry && (entry = ""),
                    isStatic || !0 !== test.static && void 0 !== testPos.input)
                ...
                if (void 0 !== colorMask) {
                    ...
                    !0 !== clear) {
                        ...
                        test = testPos.match,
                        ndxIntlzr = testPos.locator.slice(),
                        setEntry(buffer[pos])) : (testPos = getTestTemplate(pos, ndxIntlzr, pos - 1),
                        test = testPos.match,
                        ndxIntlzr = testPos.locator.slice(),
                        !1 === opts.jitMasking || pos < lvp || "number" == typeof opts.jitMasking && isFinite(opts.jitMasking) && opts.jitMasking > pos ? setEntry(getPlaceholder(pos, test)) : isStatic = !1),
                        pos++,
                        (void 0 === maxLength || pos < maxLength) && (!0 !== test.static || "" !== test.def) || pos < lvp || isStatic; )
                            ;
                        isStatic && setEntry(),
                        setCaret()
                    }
            ...
            function mask(elem) {
                ...
                mobile && ("inputmode"in el && (el.inputmode = opts.inputmode,
                el.setAttribute("inputmode", opts.inputmode)),
                !0 === opts.disablePredictiveText && ("autocorrect"in el ? el.autocorrect = !1 : (!0 !== opts.colorMask && initializeColorMask(el),
                el.type = "password"))),
                !0 === isSupported && (el.setAttribute("im-insert", opts.insertMode),
            ...
            if (void 0 !== actionObj)
                ...
                case "isValid":
                    actionObj.value ? (valueBuffer = actionObj.value.split(""),
                    checkVal.call(this, void 0, !0, !0, valueBuffer)) : actionObj.value = isRTL ? getBuffer().slice().reverse().join("") : getBuffer().join("");
                ...
                case "remove":
                    if (el && el.inputmask) {
                        ...
                        EventRuler.off(el),
                        el.inputmask.colorMask && (colorMask = el.inputmask.colorMask,
    ...
    , function(module, exports, __webpack_require__) {
        ...
        function FindPlusValidator(maskset) {
            ...
            for (posNdx in maskset.validPositions)
                ;
            for (var tstNdx in posNdx = parseInt(posNdx),
            maskset.tests)
                if (tstNdx = parseInt(tstNdx),
                posNdx <= tstNdx)
                    for (var ndx = 0, ndxl = maskset.tests[tstNdx].length; ndx < ndxl; ndx++)
                        if (void 0 === maskset.validPositions[tstNdx] && "+" === maskset.tests[tstNdx][ndx].match.def)
                            return tstNdx + (void 0 !== maskset.validPositions[tstNdx] ? 1 : 0);
            return posNdx
        }
            ...
            numeric: {
                ...
                preValidation: function preValidation(buffer, pos, c, isSelection, opts, maskset) {
                    ...
                    "-" !== c && c !== opts.negationSymbol.front)
                        return -1 !== radixPos && !0 === opts._radixDance && !1 === isSelection && c === opts.radixPoint && void 0 !== opts.digits && (isNaN(opts.digits) || 0 < parseInt(opts.digits)) && radixPos !== pos ? {
                ...
                postValidation: function postValidation(buffer, pos, currentResult, opts) {
                    if (null !== opts.min || null !== opts.max) {
                        ...
                        if (null !== opts.min && unmasked < opts.min && unmasked.toString().length >= opts.min.toString().length)
                            return !1;
                ...
                onBeforeMask: function onBeforeMask(initialValue, opts) {
                    ...
                    "" !== decimalPart)) {
                        ...
                        isFinite(initialValue) && (initialValue = Math.round(parseFloat(initialValue) * digitsFactor) / digitsFactor),
